...
const protectionService = require('./protection_service');// <-- Import protection service

// Initialize Express
const app = express();
const port = process.env.PORT || 13964;
const websocketPort = process.env.WEBSOCKET_PORT || 13965;
...
async function loadRoutes(db) {
    ...
    app.use('/api', protectionService(db)); // <-- Use protection service

...
// Forgot password route
  router.post('/forgot-password', async (req, res) => {
    ...
    try {
      ...
      const resetLink = `https://famieproject.com/reset-password/${resetToken}`; // Update this link to your actual reset password URL
      ...
      const transporter = nodemailer.createTransport({
        ...
        auth: {
          ...
          pass: process.env.EMAIL_PASSWORD || 'kzugjzbkwvgbnntk', // Use the App Password here
        },
      });

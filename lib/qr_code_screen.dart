...
class QrCodeScreenState extends State<QrCodeScreen> {
  ...
  Future<String?> getMacAddress() async {
    ...
    if (connectivityResult == ConnectivityResult.wifi) {
      ...
      return 'Wi-Fi connected, MAC retrieval blocked on Android 10+';
    } else {
      // If not connected to Wi-Fi, return the Android ID as the MAC address
      return await getAndroidId(); // Use device ID here
    }
  }
  ...
  void _generateSvg() {
    final qrData =
        '{"macAddress": "${widget.androidId}", "deviceName": "${widget.deviceName}", "androidId": "${widget.androidId}", "childId": "${widget.childId}"}';
